...
urlpatterns = [
    ...
    path('certificate-templates/<int:template_id>/edit/', views.certificate_template_edit, name='certificate_template_edit'),
    path('certificate-templates/<int:template_id>/preview/', views.certificate_template_preview, name='certificate_template_preview'),
    path('certificate-templates/<int:template_id>/delete/', views.certificate_template_delete, name='certificate_template_delete'),
